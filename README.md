...
```javascript
log1pmx = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-log1pmx@v0.2.4-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-log1pmx/actions/workflows/test.yml/badge.svg?branch=v0.2.4
[test-url]: https://github.com/stdlib-js/math-base-special-log1pmx/actions/workflows/test.yml?query=branch:v0.2.4
